...
const routes = [
  ...
  { path: "/grievances", component: lazy(() => import("./pages/GrievancePage")) },
  { path: "/schemes", component: lazy(() => import("./pages/SchemesPage")) },
  { path: "/chat", component: lazy(() => import("./pages/ChatPage")) },
  { path: "/voice", component: lazy(() => import("./pages/VoiceAssistantPage")) },
  { path: "/analytics", component: lazy(() => import("./pages/AnalyticsPage")) },
