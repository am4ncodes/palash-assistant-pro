...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8f2e8] text-[#20251f]">
      ...
      <nav className="flex gap-5 overflow-x-auto border-b border-[#20251f]/10 px-5 py-3 font-mono text-[10px] uppercase tracking-[0.12em] text-[#6b746a] lg:hidden" aria-label="Mobile application navigation"><Link to="/translate" className="shrink-0 hover:text-[#e45d32]">Translate</Link><Link to="/learn" className="shrink-0 hover:text-[#e45d32]">Learn</Link><Link to="/library" className="shrink-0 hover:text-[#e45d32]">Library</Link><Link to="/schemes" className="shrink-0 hover:text-[#e45d32]">Schemes</Link><Link to="/grievances" className="shrink-0 hover:text-[#e45d32]">Grievances</Link><Link to="/chat" className="shrink-0 hover:text-[#e45d32]">Chat</Link><Link to="/voice" className="shrink-0 hover:text-[#e45d32]">Voice</Link><Link to="/analytics" className="shrink-0 hover:text-[#e45d32]">Analytics</Link><Link to="/community" className="shrink-0 hover:text-[#e45d32]">Community</Link><Link to="/profile" className="shrink-0 hover:text-[#e45d32]">Profile</Link><Link to="/settings" className="shrink-0 hover:text-[#e45d32]">Settings</Link><Link to="/features" className="shrink-0 hover:text-[#e45d32]">Product map</Link></nav>
